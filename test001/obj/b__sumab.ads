...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_sumab" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a7d8d1ff#;
   pragma Export (C, u00001, "sumabB");
   ...
   u00121 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00121, "system__val_intS");
   u00122 : constant Version_32 := 16#a5b55d2f#;
